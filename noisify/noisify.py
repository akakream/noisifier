...
def wrong_flip(y_train, P, random_state_seed=0):
...
def flip(y_train, P, random_state_seed=0):
...
def noisify(y_train, noise_type, noise_rate, num_classes, random_state_seed):
    if noise_type == 'symmetry':
        symmetry_flipping(y_train, noise_rate, num_classes, random_state_seed)
    elif noise_type == 'pair':
        pair_flipping(y_train, noise_rate, num_classes, random_state_seed)
